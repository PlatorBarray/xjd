 ...
 * ============================================================================
 * $Author: derek $
 * $Id: inc_constant.php 17217 2015-02-10 06:29:08Z derek $
*/
...
// 代码增加_start_derek_dsh_k20150306

define('PS_PAYBACK',                3); // 退款中

// 代码增加_end_derek_dsh_k20150306

/* 综合状态 */
define('CS_AWAIT_PAY',              100); // 待付款：货到付款且已发货且未付款，非货到付款且未付款
define('CS_AWAIT_SHIP',             101); // 待发货：货到付款且未发货，非货到付款且已付款且未发货

// 代码修改_start_derek_dsh_k20150306

define('CS_FINISHED',               102); // 已完成：已确认、已付款、已发货、已收货
define('CS_AWAIT_COMMENT',          103); // 待评价

// 代码修改_end_derek_dsh_k20150306
