...
$_LANG['cfg_desc']['comments_number'] = '显示在商品详情页的每页用户评论数量。默认5';
...
$_LANG['cfg_desc']['erweima_wapurl']      = ' 输入格式：http://您的域名/goods.php?id={id}<br>如果您购买了微商城，输入格式：http://您的域名/mobile/goods.php?id={id}';
...
$_LANG['cfg_desc']['email_domain'] = '提示：域名之间用“，”隔开（逗号不分全角、半角），域名无须带www<br>参照样式：163.com,68ecshop.com,sina.com';
/* 代码增加_end   By  www.68ecshop.com  */
/* 晒单插件  添加 by www.68ecshop.com */
...
$_LANG['cfg_name']['ecsdxt_user_name'] = '短信服务账户';
$_LANG['cfg_desc']['ecsdxt_user_name'] = '短信服务商提供的供系统发送短信所需要的账户';

$_LANG['cfg_name']['ecsdxt_pass_word'] = '短信服务密码';
$_LANG['cfg_desc']['ecsdxt_pass_word'] = '短信服务商提供的供系统发送短信所需要的密码';

$_LANG['cfg_name']['sms_shop_mobile'] = '商家的手机号码';
$_LANG['cfg_desc']['sms_shop_mobile'] = '请先注册手机短信服务再填写手机号码';

$_LANG['cfg_name']['sms_sign'] = '短信签名';
$_LANG['cfg_desc']['sms_sign'] = '提示：短信签名及短信内容请勿随意修改，修改时需要向短信运营商备案后方可正常使用，否则会导致短信发送失败';
...
/* 代码增加_注册红包start  By  www.68ecshop.com */
...
/* 代码增加_注册红包end  By  www.68ecshop.com */
