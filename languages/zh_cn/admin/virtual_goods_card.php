...
$_LANG['go_list'] = '返回虚拟券列表';
$_LANG['continue_add'] = '继续修改';
...
/* 虚拟团购_添加_START_www.68ecshop.com */
$_LANG['virtual_order_list'] = '虚拟券订单列表';
$_LANG['virtual_verification'] = '虚拟券验证';
$_LANG['input_virtual_verification'] = '请输入虚拟券号码';
$_LANG['message']['not_found_verification'] = '未找到此验证码,验证失败';
$_LANG['message']['verification_success'] = '验证成功';
$_LANG['message']['verification_used'] = '此验证码已被使用,验证失败';
$_LANG['message']['verification_overdue'] = '此验证码已经过期,验证失败';
/* 虚拟团购_添加_END_www.68ecshop.com */
?>