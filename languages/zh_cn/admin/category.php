...
$_LANG['is_show_cat_pic'] = '是否设置为首页推荐';
$_LANG['cat_pic'] = '上传店铺此类广告图';
$_LANG['cat_pic_url'] = '店铺广告图链接';
$_LANG['cat_goods_limit'] = '首页此类商品显示数量';
...
$_LANG['filter_attr_notic'] = '筛选属性可在当前分类页面进行筛选商品';
...
$_LANG['cat_expand'] = '[全部展开]';
$_LANG['cat_collect'] = '[全部收缩]';

$_LANG['virtual_category_list'] = '虚拟劵商品分类管理';
/* 代码增加 By  www.68ecshop.com Start */
$_LANG['export'] = '导出分类结构';
$_LANG['category_search'] = '搜索商品分类';
