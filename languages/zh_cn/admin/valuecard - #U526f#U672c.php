 ...
 * ============================================================================
 * $Author: derek $
 * $Id: valuecard.php 17217 2015-02-10 06:29:08Z derek $
*/

/* 红包类型字段信息 */
$_LANG['valuecard_type_add'] = '添加储值卡类型';
$_LANG['19_valuecard_list'] = '储值卡类型列表';
$_LANG['valuecard_type_add'] = '添加储值卡类型';
$_LANG['type_money'] = '储值卡金额';
$_LANG['send_count'] = '发放数量';
$_LANG['use_startdate_notic'] = '只有当前时间介于起始日期和截止日期之间时，此类型的储值卡才可以使用';
$_LANG['type_name_exist'] = '此类型的名称已经存在!';
$_LANG['continus_add'] = '继续添加储值卡类型';
...
$_LANG['js_languages']['type_name_empty'] = '请输入储值卡类型名称!';
$_LANG['js_languages']['type_money_empty'] = '请输入储值卡金额!';
$_LANG['js_languages']['type_money_isnumber'] = '储值卡金额必须为数字格式!';
...
$_LANG['send_valuecard'] = '发放储值卡';
$_LANG['send_valucard_count'] ='本次发放数量';
$_LANG['valuecard_sn_notic'] = '提示:储值卡卡号由“日期+ 8位随机数字”组成';
$_LANG['bonustype_edit'] = '编辑储值卡类型';
$_LANG['valuecard_have'] = '该类型下已经发放了大量储值卡，不能删除！';
$_LANG['continue_add'] = '继续添加储值卡';
$_LANG['back_bonus_list'] = '返回储值卡列表';

$_LANG['creat_bonus'] = '生成了 ';
$_LANG['creat_bonus_num'] = ' 个储值卡号码';
$_LANG['bonus_sn_error'] = '储值卡号码必须是数字!';
$_LANG['valuecard_list'] = '储值卡列表';
$_LANG['no_use'] = '未使用';
$_LANG['bonus_sn'] = '储值卡号';
$_LANG['vc_pwd'] = '密码';
$_LANG['batch_drop_success'] = '成功删除了 %d 个储值卡';
$_LANG['gen_excel'] = '导出EXCEL';
$_LANG['vc_sn'] = '储值卡号：';
$_LANG['bonus_type'] = '储值卡类型';
$_LANG['type_name'] = '储值卡类型名称';
