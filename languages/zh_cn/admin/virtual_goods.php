...
$_LANG['notice_valid_date']      = '此商品虚拟券使用的截至日期';
$_LANG['notice_district']      = '选择区域后，双击商圈即可添加商圈，可添加多个商圈';
...
$_LANG['goods_sn_exists'] = '您输入的货号已存在，请换一个';
$_LANG['supplier_district_manage'] = '入驻商商圈管理';
$_LANG['add_district'] ='添加新商圈';
$_LANG['continue_add_district'] ='添加新商圈';
$_LANG['back_district_list'] = '返回商圈列表';
$_LANG['mes_add_district_success'] = '恭喜你,商圈添加成功';
$_LANG['mes_edit_district_success'] = '恭喜你,商圈修改成功';
$_LANG['virtual_goods_list'] = '自营虚拟商品列表';
$_LANG['supp_virtual_goods_list']  = '入驻商虚拟商品列表';
$_LANG['add_virtual_goods']  = '添加虚拟商品';
$_LANG['edit_virtual_goods']  = '编辑虚拟商品';
$_LANG['copy_virtuale_goods'] = '复制虚拟商品';
$_LANG['01_virtual_goods_list'] = '虚拟商品列表';
$_LANG['error_choose_district'] = '请选择需要删除的商圈';
?>