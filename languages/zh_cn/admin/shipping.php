...
$_LANG['is_default_show'] = '配送方式 %s 已经成功设置。';
...
/* JS 语言 */
$_LANG['js_languages']['lang_isdefaultshowconfirm'] = '设置成功后，前台用户选择的配送方式及所有已经安装的配送方式都将和此配送方式的运费及配送区域同步,您确定要设置吗？';
