    ...
    f.pt.move = function() {
        ...
        function(a) {
            if (a.preventDefault(), "ok" === c(this).attr("move")) {
                ...
                var f = 2 * parseFloat(e.layero.css("border-width")),
                h = e.layero.offset().left,
                i = e.layero.offset().top,
                j = e.layero.width() - 6 + f,
                k = e.layero.height() - 6 + f;
                c("#layui-layer-moves")[0] || c("body").append('<div id="layui-layer-moves" class="layui-layer-moves" style="left:' + h + "px; top:" + i + "px; width:" + j + "px; height:" + k + 'px; z-index:2147483584"></div>'),
