...
if(isset($_REQUEST['act']) && $_REQUEST['act'] == 'del')
{
	...
	$id = intval($_REQUEST['id']);
	$sql = "DELETE FROM " .$GLOBALS['ecs']->table('user_deposit') . " WHERE id = '$id' AND user_id = '" . $_SESSION['user_id'] . "'";
...
if(isset($_REQUEST['act']) && $_REQUEST['act'] == 'act_deposit')
{
	...
	{
		 $sql = "SELECT * FROM " . $GLOBALS['ecs']->table('user_deposit') . " WHERE id = '$id' AND user_id = '" . $_SESSION['user_id'] . "'";
...
{
	 $sql = "SELECT * FROM " . $GLOBALS['ecs']->table('user_deposit') . " WHERE id = '$id' AND user_id = '$user_id'";
