 ...
 * ============================================================================
 * $Author: derek $
 * $Id: qfkd.php 17217 2011-01-19 06:29:08Z derek $
 */
...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/qfkd.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_qfkd.jpg';
