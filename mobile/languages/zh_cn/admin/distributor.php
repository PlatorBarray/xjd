...
$_LANG['is_fenxiao'] = '是否是分销商';
$_LANG['one_level_user'] = '一级会员';
$_LANG['two_level_user'] = '二级会员';
$_LANG['three_level_user'] = '三级会员';
$_LANG['four_level_user'] = '四级会员';
$_LANG['five_level_user'] = '五级会员';
$_LANG['no_distributor'] = '非分销商无法查看';
$_LANG['go_back'] = '返回上一页';
$_LANG['01_users_list'] = '分销商列表';
$_LANG['upper_distrib'] = '上级分销商';
$_LANG['total_user'] = '下线会员总数';
$_LANG['all_user'] = '全部分销商会员';
$_LANG['other_user'] = '其他分销商会员';
$_LANG['plat_user'] = '平台方分销商会员';
$_LANG['not_user'] = '非分销商会员';
...
$_LANG['parent_user'] = '上级分销商';
$_LANG['parent_remove'] = '脱离分销关系';
