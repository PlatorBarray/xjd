...
$_LANG['cfg_name']['pc_url'] = '图片调用路径';
$_LANG['cfg_name']['simgnum'] = '允许晒单图片的数量';

$_LANG['cfg_desc']['pc_url'] = '设置微信端读取商品图片的路径,例如：http://您的域名';
...
/*yyy 20151225 add start*/
$_LANG['cfg_desc']['shop_name'] = '修改前台首页顶部标题文字；并且也是短信后缀(10字以内,不可包含特殊字符)';
$_LANG['cfg_desc']['service_phone'] = '修改前台页面底部菜单客服电话';
/*yyy 20151225 add end*/
...
$_LANG['cfg_name']['distrib'] = '分销设置';

$_LANG['cfg_name']['is_distrib'] = '是否开启微分销';
$_LANG['cfg_range']['is_distrib'][1] = '是';
$_LANG['cfg_range']['is_distrib'][0] = '否';

$_LANG['cfg_name']['distrib_rank'] = '成为分销商的会员等级';

$_LANG['cfg_name']['call_username'] = '会员名称调用';
$_LANG['cfg_range']['call_username'][1] = '会员ID';
$_LANG['cfg_range']['call_username'][0] = '会员名称';

$_LANG['cfg_name']['distrib_type'] = '分成模式';
$_LANG['cfg_range']['distrib_type'][1] = '按商品分成';
$_LANG['cfg_range']['distrib_type'][0] = '按订单分成';
$_LANG['cfg_desc']['distrib_type'] = '按商品分成，分成金额计算以本店售价/促销价格/会员价格为准；按订单分成，默认所有商品都是分销商品';

$_LANG['cfg_name']['distrib_percent'] = '订单分成百分比';
$_LANG['cfg_desc']['distrib_percent'] = '选择按订单分成，此值将作为订单总额的百分比进行分成！';

$_LANG['cfg_name']['deposit_least_money'] = '每次提现的最低金额';
$_LANG['cfg_name']['reserve_money'] = '账户预留金额';

$_LANG['cfg_name']['is_add_distrib'] = '入驻商商品可否加入分销商品中';
$_LANG['cfg_range']['is_add_distrib'][1] = '是';
$_LANG['cfg_range']['is_add_distrib'][0] = '否';

$_LANG['cfg_name']['search_goods_count'] = '添加分销商品可搜索商品条数';
$_LANG['cfg_desc']['search_goods_count'] = '为0时，代表可搜索出全部商品';

$_LANG['cfg_name']['distrib_style'] = '分成方式';
$_LANG['cfg_range']['distrib_style'][1] = '手动分成';
$_LANG['cfg_range']['distrib_style'][0] = '自动分成';
$_LANG['cfg_desc']['distrib_style'] = '自动分成是客户确认收货之后就自动分成，手动分成是管理员发货后，手动去分成订单管理点击分成！';
