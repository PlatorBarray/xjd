...
$_LANG['user_name_exist'] = '此用户名已经有人使用';
$_LANG['user_name_empty'] = '用户名不能为空';
...
$_LANG['cancel'] = '取消订单';
$_LANG['pay_money'] = '立即付款';
$_LANG['view_order'] = '查看订单';
$_LANG['view_wuliu'] = '查看物流';
$_LANG['comment_shaidan'] = '评价晒单';
$_LANG['received'] = '确认收货';
...
$_LANG['confirm_received'] = '您确认已经收到货物了吗？确认收货后不可再申请退货，请确认收到的货物没有问题。';
...
　<span>１</span>、将本站提供给您的推荐代码，发送到论坛、博客上。
　<span>２</span>、访问者点击链接，访问网店。
　<span>３</span>、在访问者点击链接的 <b>%d%s</b> 内，若该访问者在本站注册，即认定该用户是您推荐的，您将获得等级积分 <b>%d</b> 的奖励 (当您的等级积分超过 <b>%d</b> 时，不再获得奖励)。
　<span>４</span>、该用户今后在本站的一切消费，您均能获得一定比例的提成。目前实行的提成总额为订单金额的 <b>%s</b> 、积分的 <b>%s</b> ，分配给您、推荐您的人等，具体分配规则请参阅 <b><a href="#myrecommend">我推荐的会员</a></b>。
　<span>５</span>、提成由管理员人工审核发放，请您耐心等待。
　<span>６</span>、您可以通过分成明细来查看您的介绍、分成情况。';
$_LANG['affiliate_intro'][1] = '　　本网店为鼓励推荐新用户注册，现开展<b>推荐订单分成</b>活动，活动流程如下：
　<span>１</span>、在浏览商品时，点击推荐此商品，获得推荐代码，将其发送到论坛、博客上。
　<span>２</span>、访问者点击链接，访问网店。
　<span>３</span>、在访问者点击链接的 <b>%d%s</b> 内，若该访问者在本站有订单，即认定该订单是您推荐的。
　<span>４</span>、您将获得该订单金额的 <b>%s</b> 、积分的 <b>%s</b>的奖励。
　<span>５</span>、提成由管理员人工审核发放，请您耐心等待。
　<span>６</span>、您可以通过分成明细来查看您的介绍、分成情况。';
