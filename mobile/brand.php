...
if (!empty($_REQUEST['act']) && $_REQUEST['act'] == 'ajax')
{
	...
	$goodslist = brand_get_goods($brand_id, $cate, $size, $page, $sort, $order, $limit);
 ...
 * @return  array
 */
function brand_get_goods($brand_id, $cate, $size, $page, $sort, $order, $limit='')
{
