...
if (!$smarty->is_cached('v_user_notes.dwt', $cache_id))
{
    assign_template();
	...
	$smarty->assign('notes_list',get_users_notes($_SESSION['user_id']));
    /* 页面中的动态内容 */
    assign_dynamic('v_user_notes.dwt');
}

$smarty->display('v_user_notes.dwt', $cache_id);
