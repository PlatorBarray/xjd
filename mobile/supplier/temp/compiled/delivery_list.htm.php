...
?>
                <li>
                  <table width="100%" cellpadding="3" cellspacing="1" >
                    <tr>
                      <td align="left"><span>发货单流水号</span><?php echo $this->_var['delivery']['delivery_sn']; ?></td>
                    </tr>
                    <tr>
                      <td align="left"><span>订单号</span><?php echo $this->_var['delivery']['order_sn']; ?><div class="buy_name"><i>收货人</i><?php echo $this->_var['delivery']['consignee']; ?></div></td>
                    </tr>
                    <tr>
                      <td align="left"><span>下单时间</span><?php echo $this->_var['delivery']['add_time']; ?></td>
                    </tr>
                    <tr>
                      <td align="left"><span>发货时间</span><?php echo $this->_var['delivery']['update_time']; ?></td>
                    </tr>
                    <tr>
                      <td align="left"><span>发货状态</span><?php echo $this->_var['delivery']['status_name']; ?>
                        <a href="order.php?act=remove_delivery&delivery_id=<?php echo $this->_var['delivery']['delivery_id']; ?>" class="font1">移除</a>
                        <a href="order.php?act=delivery_info&delivery_id=<?php echo $this->_var['delivery']['delivery_id']; ?>">查看</a></td>
                    </tr>
                  </table>
                </li>
                <?php endforeach; else: ?>
