    ...
    <section>
      ...
      <div class="order_con" id="con_order_manage_1">
        <ul class="back_list_type back_list_type1">
          <li <?php if (! $this->_var['filter']['order_type'] || $this->_var['filter']['order_type'] == ''): ?>class="curr"<?php endif; ?> id="type1" onclick="change_order_type('')"><span>全部<i></i></span></li>
          <li <?php if ($this->_var['filter']['order_type'] == '2'): ?>class="curr"<?php endif; ?> id="type2" onclick="change_order_type('2')"><span>未完成<i></i></span></li>
          <li <?php if ($this->_var['filter']['order_type'] == '3'): ?>class="curr"<?php endif; ?> id="type3" onclick="change_order_type('3')"><span>已完成<i></i></span></li>
        </ul>
...
?>
              <li>
                <table width="100%" cellpadding="3" cellspacing="1" >
                  ...
                  <?php $_from = $this->_var['back_order']['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
    foreach ($_from AS $this->_var['goods']):
?>
                  <tr>
                    <td colspan="3" align="left">ID：<?php echo $this->_var['goods']['goods_id']; ?>&nbsp;&nbsp;<?php if ($this->_var['back_order']['brand_name']): ?>[<?php echo $this->_var['back_order']['brand_name']; ?>]<?php endif; ?><?php echo $this->_var['goods']['goods_name']; ?></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="right"><a href="back.php?act=back_info&back_id=<?php echo $this->_var['back_order']['back_id']; ?>">查看</a><a href="back.php?act=remove_back&back_id=<?php echo $this->_var['back_order']['back_id']; ?>" class="font1">移除</a></td>
                  </tr>
                </table>
              </li>
              <?php endforeach; else: ?>
