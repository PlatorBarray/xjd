...
/* 生成静态页面的配置 */
if(!defined('PREFIX_CATEGORY'))
{
	define('PREFIX_CATEGORY', 'shangpin');   //保存 商品页、商品列表页的子目录前缀，不需要写 -
}
if(!defined('PREFIX_ARTICLECAT'))
{
	define('PREFIX_ARTICLECAT', 'wenzhang');   //保存 商品页、商品列表页的子目录前缀，不需要写 -
}
if(!defined('PREFIX_TOPIC'))
{
	define('PREFIX_TOPIC', 'zhuanti');   //保存 商品页、商品列表页的子目录前缀，不需要写 -
}
