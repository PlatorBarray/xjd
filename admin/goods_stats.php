 ...
 * ============================================================================
 * $Author: langlibin $
 * $Id: goods_stats.php 2015-10-28 11:02:08Z langlibin $
 */
...
if ($_REQUEST['act'] == 'list')
{
    ...
    $result = get_sell_list($start_date, $end_date, $sel_shop, $supplier_id);
 ...
 * @return array
 */
function get_sell_list($start_date, $end_date, $sel_shop, $supplier_id)
{
    $result = get_filter();
    if($result === false)
    {
