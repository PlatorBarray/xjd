...
function get_sysnav()
{
    ...
    $sysmain = array(
		...
		array($_LANG['pro_sale'], 'pro_sale.php'),
	    array($_LANG['auction'], 'auction.php'),
	   	array($_LANG['package'],'package.php'),
		array($_LANG['pro_search'],'pro_search.php'),
        array($_LANG['exchange'], 'exchange.php'),
		
        array($_LANG['kuaidi'], 'kuaidi.php'),
	    array($_LANG['scan'], 'scan.php'),
		
		array($_LANG['article_list'], 'article_list.php'),
		array($_LANG['stores'],'stores.php'),
