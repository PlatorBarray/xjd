...
if ($_REQUEST['act'] == 'list')
{
	...
	if (isset($_CFG['supplier_comment']))
	{
		$smarty->assign('supplier_comment', $_CFG['supplier_comment']);
	}
...
if ($_REQUEST['act']=='reply')
{
    ...
    /* 获取管理员的用户名和Email地址 */
    $sql = "SELECT user_name, email FROM ". $ecs->table('supplier_admin_user').
           " WHERE user_id = '$_SESSION[supplier_admin_id]'";
	...
	if (isset($_CFG['supplier_comment']))
	{
		$smarty->assign('supplier_commentshow', $_CFG['supplier_comment']);
	}
