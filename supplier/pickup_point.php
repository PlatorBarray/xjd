...
if ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('pickup_point')."(shop_name, address, contact, phone, province_id, ".
                "city_id, district_id,supplier_id) ".
            "VALUES ('$_POST[shop_name]', '$_POST[address]', '$_POST[contact]', '$_POST[phone]', ".
                "'$_POST[province]', '$_POST[city]', '$_POST[district]',".$_SESSION['supplier_id'].")";
    $db->query($sql);
...
function get_pickup_point_list()
{
    ...
    if ($result === false)
    {
        ...
        $sql = 'SELECT * '.
               ...
               'WHERE supplier_id='.$_SESSION['supplier_id'] .$where. ' ORDER by '.$filter['sort_by'].' '.$filter['sort_order'];
