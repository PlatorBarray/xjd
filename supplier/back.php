...
function back_list()
{
    ...
    if ($result === false)
    {
        ...
        $filter['suppid'] = (isset($_REQUEST['suppid']) && !empty($_REQUEST['suppid']) && intval($_REQUEST['suppid'])>0) ? intval($_REQUEST['suppid']) : ((!empty($_SESSION['supplier_id']) && $_SESSION['supplier_id'] > 0) ? $_SESSION['supplier_id'] : 0);
